...
export default function TableBody() {
  ...
  const content = orderedCycles.map((cycle) => {
    ...
    return (
      ...
      >
        <td className="max-w-2xl px-3 py-2 group-last:rounded-bl">
          <span className="wrap-text text-sm font-semibold text-theme-gray-200 md:text-base">
            {cycle.task || 'No task assigned to this cycle'}
          </span>
        </td>
        <td className="px-3 py-2">
          <span className="text-sm font-semibold text-theme-gray-200 md:text-base">
        ...
        <td className="px-3 py-2 group-last:rounded-br">
